            ...
            <div class="card-body px-lg-5 py-lg-5">
                ...
                @if ($errors->has('name')||$errors->has('email')||$errors->has('password'))
                    <div class="alert alert-warning alert-dismissible fade show" role="alert">
                      ...
                      @if ($errors->has('name'))
                      <span class="alert-inner--text">{{ $errors->first('name') }}</span>
                      @endif
                      @if($errors->has('email'))
                      <br><span class="alert-inner--text">{{ $errors->first('email') }}</span>
                      @endif
                      @if($errors->has('password'))
                      <br><span class="alert-inner--text">{{ $errors->first('password') }}</span>
                      @endif
              ...
              <form role="form" method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group mb-3">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" placeholder="{{ __('Name') }}" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name') }}"  autofocus>
                  </div>
                    @if ($errors->has('name'))
                    ...
                    <div class="form-group mb-3">
                        <div class="input-group input-group-alternative">
                          ...
                          <input class="form-control" placeholder="{{ __('Email') }}" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" >
                        </div>
                          @if ($errors->has('email'))
                ...
                <div class="form-group">
                  <div class="input-group input-group-alternative">
                    ...
                    <input  placeholder="{{ __('Password') }}" id="password" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" >
                        @if ($errors->has('password'))
                     ...
                     <div class="form-group">
                        <div class="input-group input-group-alternative">
                          ...
                          <input placeholder="{{ __('Confirm Password') }}"  id="password-confirm" type="password" class="form-control" name="password_confirmation" >
                        </div>
                      </div>
